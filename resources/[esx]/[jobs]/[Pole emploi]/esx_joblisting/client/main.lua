...
-----> Activer le menu lorsque le joueur est à l'intérieur du marqueur et dessiner des marqueurs
Citizen.CreateThread(function()
	while true do
		Citizen.Wait(1)
...
-- Create blips
local blips = {
     {title="Pole-Emplois", colour=27, id=354, x = -269.7840, y = -955.142, z = 31.2231},
  }
